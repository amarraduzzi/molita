...
export const ProductsSection: React.FC<ProductsSectionProps> = ({
  ...
  return (
    <section id="produits" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
        ...
        <p className="text-base sm:text-lg text-stone-600 font-sans leading-relaxed">
          Chaque produit Molita associe des vitamines spécifiques et des extraits naturels de plantes. Découvrez la formule adaptée à votre quotidien.
        </p>
      </div>

      {/* Product Cards Grid - Asymmetric & Distinctive Circle-in-Circle Flyer Style */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {MOLITA_PRODUCTS.map((product, idx) => {
          return (
            <div
              key={product.id}
            ...
            >
              ...
              <div>
                ...
                <div className="space-y-2 mb-6">
                  ...
                  <div className="flex flex-wrap justify-center gap-1.5">
                    {product.vitamins.slice(0, 4).map((vit, vIdx) => (
                      <span
                        key={vIdx}
              ...
              <div className="pt-4 border-t border-stone-100 flex items-center justify-between gap-3">
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    onOpenCallback(product);
                  }}
                  className="px-4 py-2 rounded-full text-xs font-semibold text-white transition-all shadow-xs hover:shadow-md hover:scale-105"
                  style={{
