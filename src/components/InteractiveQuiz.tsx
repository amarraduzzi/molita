...
export const InteractiveQuiz: React.FC<InteractiveQuizProps> = ({
  ...
  return (
    <section id="diagnostic" className="py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      <div className="bg-gradient-to-br from-stone-900 via-purple-950 to-stone-900 text-white rounded-3xl p-6 sm:p-12 shadow-2xl relative overflow-hidden border border-purple-800/30">
        ...
        {/* Step Progress Bar */}
        <div className="relative z-10 max-w-md mx-auto mb-10 flex items-center justify-between text-xs font-medium text-stone-400">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-8 animate-fadeIn">
              ...
              {recommendations.map((prod, idx) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-[10px] text-stone-400 font-semibold uppercase">
                        {idx === 0 ? 'Produit Référent' : 'Complément Idéal'}
                      </span>
                  ...
                  <div className="pt-2 border-t border-stone-700/60 flex items-center justify-between">
                    ...
                    <button
                      onClick={() => onOpenCallback(prod)}
                      className="px-3.5 py-1.5 rounded-full text-xs font-semibold text-white shadow-xs"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              >
                ...
                Demander mon diagnostic au téléphone (Gratuit)
              </button>
