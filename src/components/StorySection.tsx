...
export const StorySection: React.FC = () => {
  return (
    <section id="histoire" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 relative">
          ...
          <div className="relative z-10 bg-white p-8 sm:p-10 rounded-3xl shadow-xl border border-stone-200/80 space-y-6">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-purple-600 to-indigo-600 text-white flex items-center justify-center font-serif text-3xl font-bold shadow-md">
              M
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <div className="w-10 h-10 rounded-full bg-stone-200 overflow-hidden flex items-center justify-center font-serif font-bold text-stone-700 text-sm">
                S.M
              </div>
              <div>
                <span className="font-semibold text-stone-900 text-sm block">Équipe Fondatrice Molita</span>
                <span className="text-xs text-stone-500">Genève & Casablanca</span>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-6 space-y-6 lg:pl-6">
          ...
          <p className="font-sans text-stone-600 text-base sm:text-lg leading-relaxed">
            Chez <strong className="text-stone-900 font-semibold">Molita</strong>, nous avons repensé la complémentation nutritionnelle. Fini les gélules difficiles à avaler et les traitements austères.
          </p>

          <p className="font-sans text-stone-600 text-sm sm:text-base leading-relaxed">
            Nos gummies sont élaborées à partir de <strong className="text-stone-900">pectine de fruits 100% végétale</strong> (sans gélatine animale), enrichies en extraits botaniques titrés (Ginkgo Biloba, Guarana, Rhodiola, Aubépine) et en vitamines hautement bio-assimilables.
          </p>
